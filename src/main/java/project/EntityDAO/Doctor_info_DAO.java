...
public class Doctor_info_DAO {
	...
	private Clinic_repository clinic_repo;
	 ...
	 public Doctor_info addNewDoctor1(Doctor_info doc,Clinic_info clinic)
	 {
		 clinic_repo.save(clinic);
		 Doctor_info adddoc= doctor_repo.save(doc);
		 return adddoc;
	 }
	 ...
	 public String forgetpassdoctor(long mob,String newpassword)
		{
		 		Doctor_info doct =doctor_repo.finddoctor(mob);
		 		System.out.println(doct.getDoctor_id());
