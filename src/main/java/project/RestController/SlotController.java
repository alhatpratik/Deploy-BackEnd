...
public class SlotController {
	...
	@GetMapping("/setslot/{time}/{doctor_id}/{patient_id}/{date}")
	public String setAllSlot(@PathVariable String time,@PathVariable int doctor_id,@PathVariable int patient_id,@PathVariable String date)
	{
		return repo.setSlot(time, doctor_id,patient_id,date);
	}
	...
	@GetMapping("/getbookedslot/{doctor_id}/{date}")
	public List<DoctorBookedSlot> getDoctor(@PathVariable int doctor_id,@PathVariable String date)
	{
		return repo.DoctorSlot(doctor_id,date,true);
	}
